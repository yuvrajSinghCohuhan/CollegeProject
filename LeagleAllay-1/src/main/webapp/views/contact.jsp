		...
		<div class="contact">
			<div class="container">
				...
				<div class="row">
						...
						<div class="contact-info">
							<div class="contact-item">
								...
								<div class="contact-text">
									<h2>Location</h2>
									<p>
										<a href="" target="_blank"> 498,New Gouri Nagar ,Indore </a>
									</p>
								</div>
							</div>
							<div class="contact-item">
								...
								<div class="contact-text">
									<h2>Phone</h2>
									<p>
										<a href="tel:+919617175279">+919617175279</a>
									</p>
								</div>
							</div>
							<div class="contact-item">
								...
								<div class="contact-text">
									<h2>Email</h2>
									<p>
										<a href="mailto:rupali8062@gmail.com">rupali8062@gmail.com</a>
									</p>
								</div>
							</div>
						</div>
					...
					<div class="col-md-6">
						<%
						String emailSend = (String) session.getAttribute("emailSend");
						if(emailSend==null){
							
						}
						boolean showSuccess = emailSend != null && request.getParameter("attempted") != null;
						if (showSuccess) {
						%>
